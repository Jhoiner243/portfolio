...
export default function PortfolioSection() {
  ...
  return (
    <section
      className={`min-h-screen text-white ${openSans.className} ${
        isMobile ? "px-4 py-8" : "flex items-center justify-center"
      }`}
    >
      <div className={`w-full ${isMobile ? "max-w-none" : "lg:px-12"}`}>
        {isMobile ? (
          ...
          <div className="space-y-8">
            ...
            {/* Imagen móvil - más pequeña y centrada */}
            <motion.div
              initial="hidden"
              animate="visible"
            ...
            >
              <motion.div variants={itemVariants} className="space-y-4">
                <h1 className="text-2xl leading-tight">
                  ...
                  <motion.span
                    className="text-gray-400 block mt-2 text-lg"
                    variants={textContainerVariants}
                    initial="hidden"
                    animate="visible"
                  >
                ...
                <motion.p
                  ...
                  animate="visible"
                >
                  Fundador de <HoverCardDemo />, una empresa en progreso.
                </motion.p>
              </motion.div>

              {/* Connect Section móvil */}
                  ...
                  {connections.map((connection) => (
                    ...
                    >
                      <motion.div
                        ...
                        className="flex items-center justify-between gap-3 cursor-pointer text-white border-b border-white/10 pb-3 hover:border-white/80 transition-all duration-300 px-4"
